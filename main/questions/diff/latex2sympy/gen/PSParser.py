...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write(u"\u01b9\2H\3\2\2\2\4J\3\2\2\2\6U\3\2\2\2\bY\3\2\2\2\n")
        buf.write(u"[\3\2\2\2\ff\3\2\2\2\16q\3\2\2\2\20\u0083\3\2\2\2\22")
...
class PSParser ( Parser ):
    ...
    class Mathit_textContext(ParserRuleContext):
        ...
        def LETTER(self, i=None):
            if i is None:
                ...
                return self.getToken(PSParser.LETTER, i)
    ...
    def mathit_text(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==PSParser.LETTER:
                self.state = 269
                self.match(PSParser.LETTER)
                self.state = 274
                self._errHandler.sync(self)
                _la = self._input.LA(1)
